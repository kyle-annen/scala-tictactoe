...
noremap <silent> <NL> :call smooth_scroll#down(&scroll, 0, 2)
...
silent only
cd ~/Code/scala-tictactoe
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 src/main/scala/TTTable.scala
argglobal
silent! argdel *
edit src/main/scala/TTTable.scala
...
setlocal nodiff
setlocal equalprg=
setlocal errorformat=%E\ %#[error]\ %f:%l:\ %m,%C\ %#[error]\ %p^,%-C%.%#,%Z,%W\ %#[warn]\ %f:%l:\ %m,%C\ %#[warn]\ %p^,%-C%.%#,%Z,%-G%.%#
setlocal expandtab
if &filetype != 'scala'
...
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <silent> [\D <Left>
nnoremap <buffer> <silent> [\C <Right>
nnoremap <buffer> <silent> [\B <Down>
nnoremap <buffer> <silent> [\A <Up>
let &cpo=s:cpo_save
unlet s:cpo_save
setlocal keymap=
setlocal noarabic
